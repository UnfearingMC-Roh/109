...
public class MapleSquad {
    ...
    public static enum MapleSquadType {
        ...
        bossbalrog(1), zak(1), chaoszak(1), horntail(1), chaosht(1), pinkbean(1), nmm_squad(1), vergamot(1), dunas(1), nibergen_squad(1), dunas2(1), core_blaze(1), aufheben(1), cwkpq(10), tokyo(1), vonleon(1), scartar(1), cygnus(1), showa(1), murim(1), magnas(1), hilla(1), soo(1), kapapul(1), lusid(1), gumma(1), dami(1), tokyopq(1);
